...
print(mm_scaler.fit_transform(knn_df))
#min_scaled_features = mm_scaler.fit_transform(knn_df.drop('pred',axis =1))
...
X_train, X_test, y_train, y_test = train_test_split(knn_df,knn_df['pred'], test_size=0.33)
